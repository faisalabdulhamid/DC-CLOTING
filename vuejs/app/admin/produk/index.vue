	        	...
	        	<div class="form-group form-group-sm">
	        		...
	        		<div class="col-md-9">
	        			<div class="input-group">
							<input type="text" class="form-control" v-model="form_cari" placeholder="Cari Berdasarkan Kode dan produk">
	          ...
	          <table class="table table-striped table-bordered">
	            ...
	            <tbody>
	              <tr v-for="item in table.data">
	                <td>
	                	<img :src="item.gambar" :alt="item.nama" class="img-thumbnail" width="50px">
	                </td>
	                <td>{{item.kode}}</td>
	                <td>{{item.nama}}</td>
	                <td>{{item.harga}}</td>
	                <td v-if="status.status == 'marketing'">
						<div class="btn-group btn-group-sm pull-right">
							...
							<ul class="dropdown-menu icons-right">
								<li><router-link :to="'/admin/produk/'+item.id+'/edit'"><i class="icon-pencil3"></i> Ubah</router-link></li>
