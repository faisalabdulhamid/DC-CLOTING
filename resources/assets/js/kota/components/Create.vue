	...
	<div>
		...
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
			  ...
			  <li><router-link :to="{name: 'index'}">List Data Kota</router-link></li>
		...
		<form class="form-horizontal" role="form"  v-on:submit.prevent="simpan">
		  <div class="panel panel-default">
		    <div class="panel-heading">
		      <h6 class="panel-title"><i class="icon-paragraph-right2"></i> Tambah Kota</h6>
		    </div>
		    <div class="panel-body">
		      <div class="form-group">
		        <label class="col-sm-2 control-label text-right">Provinsi</label>
		        <div class="col-sm-10">
		          <select class="form-control" v-model="data.provinsi">
		          	<option value=""></option>
		          </select>
		        </div>
		      </div>
		      <div class="form-group">
		        <label class="col-sm-2 control-label text-right">Nama Kota</label>
		        <div class="col-sm-10">
