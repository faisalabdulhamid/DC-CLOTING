	...
	<div>
      ...
      <div class="breadcrumb-line">
        <ul class="breadcrumb">
          ...
          <li class="active">List Data Pelanggan</li>
        </ul>
	  ...
	  <div class="panel panel-default">
        <div class="panel-heading">
          <h6 class="panel-title"><i class="icon-paragraph-justify2"></i> Data Pelanggan</h6>
        ...
        <div class="datatable-tasks">
          <table class="table table-bordered">
            <thead>
              <tr>
                <th>Nama</th>
                <th class="task-progress">Telepon</th>
            ...
            <tbody>
              <tr v-for="item in table.data">
                <td>{{ item.nama }}</td>
                <td class="text-center"><span class="label label-danger">{{ item.no_telepon }}</span></td>
