<template>
	...
	<div class="panel panel-default">
      	<div class="panel-heading">
        	<h6 class="panel-title"><i class="icon-users"></i> Data Kategori</h6>
			<router-link :to="{name:'kategori-tambah'}" class="btn btn-success btn-sm pull-right">Tambah</router-link>
        </div>
                ...
                <td>
					<div class="btn-group btn-group-sm pull-right">
						...
						<ul class="dropdown-menu icons-right">
							<li><router-link :to="{name: 'kategori-edit', params:{id: item.id}}"><i class="icon-pencil3"></i> Ubah</router-link></li>
