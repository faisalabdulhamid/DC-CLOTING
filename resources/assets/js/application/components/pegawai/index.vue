<template>
	...
	<div class="panel panel-default">
      	<div class="panel-heading">
			...
			<router-link v-if="user.status == 'marketing'" :to="{name:'pegawai-tambah'}" class="btn btn-success btn-sm pull-right">Tambah</router-link>
        </div>
                ...
                <td  v-if="user.status == 'marketing'">
					<div class="btn-group btn-group-sm pull-right">
						...
						<ul class="dropdown-menu icons-right">
							<li><router-link :to="{name: 'pegawai-edit', params:{id: item.id}}"><i class="icon-pencil3"></i> Ubah</router-link></li>
