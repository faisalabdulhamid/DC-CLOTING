	        ...
	        <div class="table-responsive">
	          ...
	          <table class="table table-striped table-bordered">
	            ...
	            <tbody v-for="item in table.data">
	                ...
	                <td v-if="status.status == 'marketing'" rowspan="2">
						<div class="btn-group btn-group-sm pull-right">
							...
							<ul class="dropdown-menu icons-right">
								<li><router-link :to="'/admin/kuesioner/'+item.id+'/edit'"><i class="icon-pencil3"></i> Ubah</router-link></li>
	              ...
	              <tr>
	              	<td>
	              		<span style="display: block" v-for="j in JSON.parse(item.jawaban)">{{ j.key}}</span><br/>
	              	</td>
	              </tr>
	            </tbody>
